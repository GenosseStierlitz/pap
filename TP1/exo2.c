...
int main ()  
{
  ...
  */
  ...
  printf ("OpenMP static loop %Ld cycles; %f MFLOPS\n", av-residu, (double) (N * (3.4e3) / (av-residu))) ;
  ...
  */
  ...
  printf ("OpenMP static loop dot %e: %Ld cycles; %f MFLOPS\n", r, av-residu, (double) (N * (3.4e3) / (av-residu))) ;
  init_vector (a, 1.0) ;
  init_vector (b, 2.0) ;
